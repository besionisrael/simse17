/*
 * This class defines a form for entering info about trigger constraints on an
 * action participant
 */
...
public class ActionTypeParticipantTriggerConstraintsInfoForm extends JDialog
    implements ActionListener {
  private ActionTypeTrigger outerTrigger; // outer trigger that this participant
  ...
  public ActionTypeParticipantTriggerConstraintsInfoForm(JDialog owner,
      ActionTypeParticipantTrigger trig, ActionTypeTrigger outerTrigger) {
    super(owner, true);
    this.owner = owner;
    actualTrigger = trig;
    ...
    if (outerTrigger.isGameEndingTrigger()) {
    ...
    for (int i = 0; i < attributes.size(); i++) {
      ...
      if (outerTrigger.isGameEndingTrigger()) {
        ...
        if (tempButt.isSelected()) {
          // set all others to false for this ActionTypeParticipantTrigger:
          Vector<ActionTypeParticipantConstraint> partConsts = 
          	triggerInFocus.getAllConstraints();
